    ...
    function addContact() {
        $("#btn-add").click(function () {
            ...
            $html =
                ...
                '<img src="@@webRoot/assets/images/profile/male-figure.jpg" alt="avatar" class="rounded-circle" width="35">' +
                '<div class="ms-3">' +
                ...
                '<a href="javascript:void(0)" class="text-info mail"><i class="ti ti-mail fs-5"></i></a>' +
                '<a href="javascript:void(0)" class="text-dark edit ms-2"><i class="ti ti-eye fs-5"></i></a>' +
                '<a href="javascript:void(0)" class="text-danger delete ms-2"> <i class="ti ti-trash fs-5"></i></a>' +
                "</div>" +
                "</td>" +
                "</tr>";
